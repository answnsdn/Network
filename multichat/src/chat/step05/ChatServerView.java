...
public class ChatServerView extends JFrame {
	...
	//======7. 클라이언트와 통신할 수 있도록 소켓으로부터 input/output 스트림 얻기======
	public void ioWork() {
		try {
